...
var numsucursalExp = new RegExp(/^[0-9]{9}$/);
var numsucursalValue = false;
const formulario = document.getElementById('formulario');
    ...
    $("#numero_sucursal").keyup(function (evento) {
        $("#numero_sucursal").val($("#numero_sucursal").val().toUpperCase());
        if(numsucursalExp.test($("#numero_sucursal").val())){
            $("#error_numero_sucursal").addClass("oculto");
            $("#error_numero_sucursal").removeClass("activo");
            numsucursalValue = true;
        }else{
            $("#error_numero_sucursal").addClass("activo");
            $("#error_numero_sucursal").removeClass("oculto");
            numsucursalValue = false;
        }
    });
    ...
    formulario.addEventListener('submit', (e)=>{
        if(nombreValue && apellidoValue  && usernameValue && passwordValue && emailValue && telefonoValue && dniValue && numsucursalValue){
