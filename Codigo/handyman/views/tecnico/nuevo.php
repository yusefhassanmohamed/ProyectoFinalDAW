...
<div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card shadow">
                    <div class="card-title text-center border-bottom">
                        <h2 class="p-3">Nuevo Tecnico</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="index.php?c=Tecnico&a=insertar" id="formulario">
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <p id="error_numero_identificacion" class="oculto error">Introduce un número de 9 dígitos</p>
                            </div>
                            <div class="mb-4">
    ...
    <script src="./views/public/scripts/nuevoTecnico.js"></script>
